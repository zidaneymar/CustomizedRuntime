...
using Microsoft.BotFramework.Composer.WebApp;
...
namespace Microsoft.BotFramework.Composer.WebAppTemplates
{
    public class Startup
    {
        ...
        public BotFrameworkHttpAdapter GetBotAdapter(IStorage storage, BotSettings settings, UserState userState, ConversationState conversationState, IServiceProvider s, TelemetryInitializerMiddleware telemetryInitializerMiddleware, OAuthMiddleware oAuthMiddleware)
        {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<OAuthMiddleware>(sp =>
            {
                return new OAuthMiddleware(this.Configuration, conversationState);
            });
            ...
            services.AddSingleton<IBotFrameworkHttpAdapter, BotFrameworkHttpAdapter>((s) => GetBotAdapter(storage, settings, userState, conversationState, s, s.GetService<TelemetryInitializerMiddleware>(), s.GetService<OAuthMiddleware>()));
